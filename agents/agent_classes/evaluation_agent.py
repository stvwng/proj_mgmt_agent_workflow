...
class EvaluationAgent(BaseAgent):
    ...
    def __init__(
        ...
        '''
        Initialize an EvaluationAgent instance. EvaluationAgent evaluates responses from other agents and 
        provides feedback to improve those responses.
        
        Args:
        openai_instance (OpenAI): an OpenAI client
        instructions (str): instructions for the EvaluationAgent (system prompt)
        evaluation_criteroa (str): criteria for evaluating the response generated by another agent
        worker_agent (BaseAgent): the agent to be evaluated
        max_interactions (int): the max number of times the EvaluationAgent evaluates feedback of the other agent; defaults to 5
    ...
    def evaluate(self, initial_input: str) -> Dict:
        ...
        Args:
        initial_input (str): the first response of another agent to be evaluated
