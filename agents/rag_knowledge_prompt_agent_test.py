...
RAG_knowledge_prompt_agent = RAGKnowledgePromptAgent(client, persona, 500, 200)
...
print(prompt)
prompt_answer = RAG_knowledge_prompt_agent.get_response_text(prompt)
assert("Crosscurrents" in prompt_answer)
print(prompt_answer)
